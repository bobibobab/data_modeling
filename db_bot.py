...
questions = [
    "Which users have selected more than 5 exercises?",
    "What are the names of users who perform 'Squats'?",
    "Which exercises are most commonly selected by users?",
    "What are the most popular categories of exercises among users?",
    "Which users perform exercises in multiple categories?",
    "Which exercises target the 'Shoulders' muscle group?",
    "What is the average number of sets performed per exercise?",
    "Which users perform high-intensity exercises?",
    "How many users perform more than one exercise in the 'Arms' category?",
    "What are the names and email addresses of users who perform 'Bench Press'?"
]
